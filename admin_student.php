...
if($result>0){
	...
	$sql=mysql_query("INSERT INTO student(first_name,last_name,postal_address,phone,email,username,password,date)
...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="admin_student.php">Student</a></li>
	...
	<div id="main">
		...
		<hr/>	
			...
			<li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Add Student</a></li>  
				...
				?>
					<td><a href="delete_student.php?student_id=<?php echo $row['student_id']?>" class="btn btn-primary">Delete</a></td>
				<?php
				}
					echo "</table>";
				?> 
				...
				<?php echo $message;?>
				<?php echo $messages;?>
				<form name="form1" onsubmit="return validateForm(this);" action="admin_student.php" method="post" align="center">
